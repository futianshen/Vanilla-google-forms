document.addEventListener('DOMContentLoaded', function () {
    ...
    function alertOn(a) {
        a.parentNode.parentNode.querySelector('.alert').innerText ='這是必填問題'
        a.style.borderBottom = '1px solid rgb(216, 66, 56)'
        a.style.background = '#ffebee'
        a.parentNode.parentNode.style.backgroundColor ='#ffebee'
    }
    function alertOff(a) {
        console.log(a.parentNode.parentNode.input)
        a.parentNode.parentNode.querySelector('.alert').innerText =''
        a.style.borderBottom = '1px solid #ddd'
        a.style.background = 'white'
        a.parentNode.parentNode.style.backgroundColor = 'white'
    }
})